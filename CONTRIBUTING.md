...
pnpm storybook      # Storybook: @iskra-ui/docs-react
...
| `pnpm build:tokens`     | Только `@iskra-ui/tokens`                                  |
...
Пакет `@iskra-ui/docs-react` в changesets **игнорируется** (не публикуется).
